...
public class TcpClient extends UntypedActor {
	...
	private static final Logger log2 = Logger.getLogger(TcpClient.class.getName());

	final InetSocketAddress remote;
	final ActorRef listener;

	public static Props props(InetSocketAddress remote, ActorRef listener) {
		return Props.create(TcpClient.class, remote, listener);
	}
	...
	public TcpClient( ActorRef listener) {
		this.remote = null;
		this.listener = listener;
